...
try:
    while True:
        message = input("You: ")  # Added a prompt so it's clear where to type
        if message.lower() == 'quit':  # Added a way to exit the chat
            print("Bot: Goodbye!")
            break
        ints = predict_class(message)
        res = get_response(ints, intents)
        print("Bot:", res)  # Added "Bot:" prefix to make the conversation clearer
except EOFError:
    print("\nChat session ended.")
